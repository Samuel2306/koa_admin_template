...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    // Dialect类是用来跟数据库完成交互的类，里面包含生成sql语句，执行查询等等功能
    ...
    // 将用来操作数据库的接口实例赋值给queryInterface属性
  ...
  normalizeAttribute(attribute) {
    ...
    // model的每一个属性必须包含type属性，因为这对应数据库每一列的数据类型
